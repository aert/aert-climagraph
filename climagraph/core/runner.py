...
from climagraph.settings import base as base_settings
...
def generate_settings():
    ...
    default_url = 'http://climagraph.example.com'
    site_url = raw_input("What will be the URL for ClimaGraph? [{0}]".format(
        default_url))
